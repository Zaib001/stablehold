...
export default function RevelationPage() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center p-4 sm:p-8 md:p-12 overflow-hidden flex-center">
      ...
      <div
        className={`w-full max-w-xl mx-auto flex flex-col items-center justify-center transition-all duration-1000 relative z-10 widget-container ${
          isLoaded ? "opacity-100" : "opacity-0"
        }`}
      >
        {/* Main message */}
        <div className="text-center space-y-6">
          <div className="text-emerald-500/80 font-mono text-xs xs:text-sm sm:text-base leading-relaxed">
            <p className="mb-4">
              Now I saw heaven opened, and behold, a white horse. And He who sat on him was called Faithful and True,
              and in righteousness He judges and makes war.
            </p>
            <p className="mb-4">
              His eyes were like a flame of fire, and on His head were many crowns. He had a name written that no one
              knew except Himself.
            </p>
            <p className="mb-4">He was clothed with a robe dipped in blood, and His name is called The Word of God.</p>
            <p className="mb-4">
              And the armies in heaven, clothed in fine linen, white and clean, followed Him on white horses.
            </p>
            <p className="mb-4">
              Now out of His mouth goes a sharp sword, that with it He should strike the nations. And He Himself will
              rule them with a rod of iron. He Himself treads the winepress of the fierceness and wrath of Almighty God.
            </p>
            <p className="mb-4">And He has on His robe and on His thigh a name written:</p>
          </div>

          <div className="text-emerald-400 font-mono text-sm xs:text-base sm:text-lg md:text-xl tracking-widest font-bold">
            KING OF KINGS AND
            <br />
            LORD OF LORDS
          </div>

          <div className="text-emerald-500/60 font-mono text-[10px] xs:text-xs tracking-wide mt-4">
            Revelation 19:11-16
          </div>

          <div className="text-emerald-900/40 font-mono text-[10px] tracking-wide mt-8">
